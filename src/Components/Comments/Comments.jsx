...
export default function ProjectDetails() {
    ...
    try {
      ...
      data.data.comments.forEach(comment => {
        if (comment.commentOwner && comment.commentOwner.image) {
          ...
          images[comment.commentOwner._id] = `http://localhost:5555${commentOwnerImageIdWithExtension}`;
        }
      });
  ...
  const deleteComment = async (commentId) => {
    try {
      await axios.delete(`http://localhost:5555/app/projectInteractions/deleteMyComment/${projectDetails._id}`, {
  ...
  const deleteCommentAdmin = async (commentId) => {
    try {
      ...
      await axios.delete(`http://localhost:5555/app/projectInteractions/deleteOneComment/${projectDetails._id}`, {
        data: { comment_Id: commentId }, // Pass the commentId as 'comment_Id' in the request body
        withCredentials: true,
      });
    ...
    try {
      ...
      if (editedContent !== null) {
        await axios.patch(`http://localhost:5555/app/projectInteractions/updateMyComment/${projectDetails._id}`, {
